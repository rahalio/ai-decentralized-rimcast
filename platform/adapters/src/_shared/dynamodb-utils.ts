 ...
 *
 * @returns The core table name (e.g., "rimcast-core-dev")
 ...
 *
 * @returns The base table name (e.g., "rimcast-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "rimcast-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "rimcast-app-realtime-dev")
